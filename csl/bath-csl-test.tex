...
The first shows the CSL-generated parenthetical citation, prefixed by the source of the example:
\begin{description}
\item[RX]
...
\end{description}
The second shows the example itself verbatim.
The third shows the reference as formatted using CSL.

Where the second and third elements differ, they are rendered in a different
colour with double top borders.
...
The following entry is not in the specification, but tests the robustness of the CSL style.
